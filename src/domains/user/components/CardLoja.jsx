...
export function CardLoja({
  ...
  return (
    <Card
      className={cn(
        "relative my-4 grid h-auto w-auto grid-cols-[25%_55%_10%] gap-4 rounded-2xl bg-[hsl(var(--secondary))] shadow-lg transition-transform duration-300 hover:scale-105 sm:p-4 lg:pl-2",
        className
      )}
      {...props}
    >
      <Link to={ROUTES.LOJA} className="contents">
